...
project_directory = '/Users/josephimbien/Desktop/EAI_projects/eai_project_problems/VRPTW-ACO-python'
...
class MultipleAntColonySystem:
    def __init__(self, graph: VrptwGraph, ants_num=10, beta=1, q0=0.1, whether_or_not_to_show_figure=True, time_windows=None, travel_times=None):        
        super().__init__()
        self.graph = graph
        ...
        # Initialize ants
        self.ants = [Ant(graph) for _ in range(ants_num)]
        self.time_window_violations = 0  # Add this line Violation function 11/September/2024
    ...
    def evaluate_solution(ant, penalty_factor=1000):
        ...
        # Add this line Violation function 11/September/2024 ///Start
    ...
    def run_multiple_ant_colony_system(self, file_to_write_path=None):
        ...
        for ant in self.ants:
            objective_value = self.evaluate_solution(ant)
