...
class Node:
    def __init__(self, id:  int, x: float, y: float, demand: float, ready_time: float, due_time: float, service_time: float):
        super()
        self.id = id
        self.customer_number = id  # assuming the id is the customer number
...
class VrptwGraph:
    def __init__(self, file_path, rho=0.1, Q=1.0): # updated this part for Q September 
        super()
        self.Q = Q # updated this part for Q
