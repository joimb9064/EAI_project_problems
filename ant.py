...
class Ant:
    ...
    def write_to_csv(self):
        ...
        with open(csv_path, 'w', newline='') as csvfile:
            fieldnames = ['Iteration', 'Customer number at node', 'Moving from node', 'To node', 'Distance traveled', 'Arrival time', 'Ready time at node', 'Start service at node', 'End service at node', 'Due date at node', 'Difference between End service and Due Date', 'Vehicle capacity before departure', 'Vehicle capacity after departure', 'Total travel distance', 'Number of vehicles used', 'Penalty', 'Nodes visited']
